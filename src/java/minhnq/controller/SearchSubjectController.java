 ...
 * @author Ticket 1
 */
@WebServlet(name = "SearchSubjectController", urlPatterns = {"/SearchSubjectController"})
public class SearchSubjectController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<SubjectDTO> list=dao.getListSubject(txtSearch);
            ...
            log("ERROR At SearchSubjectController " + e.getMessage());
        }finally{
