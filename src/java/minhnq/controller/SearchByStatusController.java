 ...
 * @author Ticket 1
 */
@WebServlet(name = "SearchByStatusController", urlPatterns = {"/SearchByStatusController"})
...
//            String subjectID="PRJ311";
            ...
            int count = dao.count2(cmbStatus);
            ...
            List<QuestionDTO> list=dao.getListQuestionByStatus(cmbStatus, index, pageSize);
            
            
            request.setAttribute("endPage", endPage);
            if(cmbStatus.toLowerCase().endsWith("true")){
                request.setAttribute("TRUE", "selected");
            }
            if(cmbStatus.toLowerCase().endsWith("false")){
...
//            request.setAttribute("SUBJECT_ID", subjectID);
            ...
            log("ERROR At SearchByStatusController " + e.getMessage());
        } finally {
